...
class Socio(db.Model):
    ...
    activities = db.relationship(
        "Activity", back_populates="socio", cascade="all, delete-orphan", lazy=True
    )
    transactions = db.relationship(
        "Transaction", back_populates="socio", cascade="all, delete-orphan", lazy=True
    )
...
class User(UserMixin, db.Model):
    ...
    attendance_records = db.relationship(
        "Attendance", back_populates="user", cascade="all, delete-orphan", lazy=True
    )
...
class Activity(db.Model):
    ...
    attendance_records = db.relationship(
        "Attendance", back_populates="activity", cascade="all, delete-orphan", lazy=True
    )
...
class Attendance(db.Model):
    ...
    __table_args__ = (
        db.UniqueConstraint("activity_id", "user_id", name="uq_activity_user_attendance"),
    )
